...
import { managedAgentProfileService, type ManagedAgentProfileInput } from "../services/managed-agent-profiles.js";
import { assertBoard, assertCompanyAccess, getActorInfo } from "./authz.js";
import { logActivity } from "../services/activity-log.js";
import { unprocessable } from "../errors.js";

function profileInput(value: unknown): ManagedAgentProfileInput {
  if (!value || typeof value !== "object") throw unprocessable("Managed Agent profile body is required");
  ...
  return {
    ...
    qualification: body.qualification && typeof body.qualification === "object"
...
export function managedAgentProfileRoutes(db: Db) {
  ...
  router.post("/companies/:companyId/managed-agent-profiles", async (req, res) => {
    ...
    await logActivity(db, {
      ...
      runId: actor.runId,
      action: "managed_agent_profile.qualified",
