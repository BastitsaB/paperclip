CREATE TABLE "global_run_admission" (
...
CREATE UNIQUE INDEX "global_run_admission_singleton_key_idx" ON "global_run_admission" USING btree ("singleton_key");--> statement-breakpoint
CREATE INDEX "heartbeat_runs_global_running_status_idx" ON "heartbeat_runs" USING btree ("status") WHERE "heartbeat_runs"."status" = 'running';