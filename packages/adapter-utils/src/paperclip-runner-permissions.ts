...
export const PAPERCLIP_RUNNER_PERMISSION_CAPABILITIES = {
  ...
  claude_managed: {
    ...
    defaultMode: "provider-managed",
    options: [],
    description: "Claude Managed runs non-interactively under its provisioned provider profile and Paperclip policy.",
  },
  aws_agentcore: {
    configurable: false,
    defaultMode: "provider-managed",
    options: [],
    description: "AWS AgentCore runs non-interactively under its provisioned harness profile and Paperclip policy.",
  },
  acpx: {
    configurable: true,
