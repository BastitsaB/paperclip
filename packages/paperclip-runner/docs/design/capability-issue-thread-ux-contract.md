...
`knowledge/evidence/capability/ui/<slug>--<desktop|mobile>.png` (package-local). Every capture
...
`knowledge/evidence/capability/cases/<group>/<case-id>--<viewport>.png`. The §10.2 matrix is
