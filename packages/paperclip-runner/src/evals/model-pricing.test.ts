...
import { estimateModelCostNanodollars, MODEL_PRICING_VERSION } from "./model-pricing.js";

describe("model pricing", () => {
  it("prices uncached, cached, and output tokens with explicit provenance", () => {
    expect(estimateModelCostNanodollars("gpt-5.6-sol", {
      inputTokens: 1_000,
  ...
  it("fails closed for an unpriced model", () => {
    expect(() => estimateModelCostNanodollars("unknown", {
      inputTokens: 1,
      cachedInputTokens: 0,
      outputTokens: 1,
